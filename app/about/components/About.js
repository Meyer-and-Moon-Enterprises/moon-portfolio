...
export default function AboutComponent() {
  ...
  const handleEmailSubmit = (e) => {
    ...
    fetch("/api/email", {
      ...
      .catch((err) => {
        setToastMessage(
          "Message not sent. Please email me directly at: jemoon20@gmail.com",
        );
        setShowToast(true);
    ...
    <Container className={`blackBackground h-100`} fluid>
      ...
      >
        <Toast
          ...
          delay={5000}
          className={`d-flex bottom-0 justify-content-center`}
          animation={true}
          bg={"primary"}
          show={showToast}
          autohide
          ...
          <div className='col d-flex flex-column justify-content-between'>
            <div className='row'>
              ...
              <p>
                ...
                and understanding things holistically.
              </p>
              <p>
                My career began as an industrial design consultant. The Texas
                Children’s Hospital was my first client, together we created the{" "}
                <a
                  style={{ textDecorationColor: "white", color: "white" }}
                  href='https://www.cambridge.org/core/services/aop-cambridge-core/content/view/E17D960F82D3BE1E5D9CCE1D0D29514B/S1551929515000607a.pdf/div-class-title-three-dimensional-printing-of-super-resolution-microscopy-images-div.pdf'
                >
                  immunology department’s 3D printing program
                </a>
                . Afterwards, an internship at IBM motivated my leap to software
                design. During my roughly 5 years at IBM, my teams primarily
                focused on improving the employee experience and supporting{" "}
                <a
                  style={{ textDecorationColor: "white", color: "white" }}
                  href='https://qz.com/755741/ibm-is-becoming-the-worlds-largest-design-company'
                >
              ...
              <p>
                My curiosity to experience a different company size & structure
                influenced my most recent role where I joined a seed startup as
                employee #7. For my next role, I’m keen to join a company with a
                sustainable mission & values.
              </p>
            </div>
            <Row className='d-flex flex-row justify-content-between flex-grow-1 align-items-center'>
              <div className='col-12 d-flex justify-content-between flex-row'>
                <div
                  className={`d-block d-lg-none mt-5`}
                  style={{ borderTop: "2px solid #2e2e2e", width: "100%" }}
                >
              ...
              <Col className='d-flex justify-content-between flex-row'>
                <div
                  ...
                  style={{ borderTop: "2px solid #2e2e2e", width: "40%" }}
                >
                  <p className='pt-3 h6'>MY SKILL SET</p>
                  <ul className='list-unstyled pt-3'>
                    <li>Experience design</li>
          ...
          <div className='col-12 col-lg-6'>
            <form>
              ...
              <button
                ...
                style={{ backgroundColor: "black", borderColor: "#2e2e2e" }}
              >
                Submit
              </button>
            </form>
