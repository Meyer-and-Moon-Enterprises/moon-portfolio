  ...
  return (
    <div className={`container blackBackground container-fluid`}>
      <div className={`container blackBackground`}>
        ...
        <div className='row justify-content-center d-flex flex-column align-items-center w-100'>
