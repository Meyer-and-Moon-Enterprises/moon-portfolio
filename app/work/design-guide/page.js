    ...
    <>
      ...
      >
        <CaseHero
          ...
          role='UX Research lead, Facilitator'
        ...
        <CaseText
          ...
          description={[
            "My primary responsibility for this project was lead user researcher. I also utilized my user experience design, usability testing, design thinking and facilitation skills.",
          ]}
          listTitle=''
          listItems={[
        ...
        <CaseText
          ...
          description={[
            "As the usability testing feedback rolled in it was clear that the initial version of the site’s architecture was confusing and dense. I was able to break out the CIO design specific guidelines from the base styles brought over by the IBM Design Language which made all the difference.",
          ]}
        />
        ...
        <CaseText
          ...
          description={[
            "Within a few months of the first draft of the CIO Design Guide going live for use, we started to see a more cohesive set of assets coming out of the design team. Below you can see a comparision of work created before the CIO Design Guide (to the left) and work produced afterwards (to the right). Adopting color, iconography and typography from the IBM Design Language went a long way in bringing the internal and external brands into alignment. Similar like sisters but still distinctly different to enable employees to differentiate between internal (light) and external (dark) facing  experiences. ",
          ]}
        />
        ...
        <CaseText
          title='Impact'
          description={[
            "Within 6 months our scrappy little team was able to deliver value by releasing our MVP as an Invision prototype. CIO designers were able to access the prototype as if it were the real site and immediately start using the templates and guidelines.",
          ]}
          listItems={[
