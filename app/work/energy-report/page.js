    ...
    <>
      ...
      >
        ...
        <CaseText
          ...
          description={[
            "I managed UX design, user research, and project expectations with stakeholders. Because this project was taken on by designers who were already fully-staffed on product teams, the initial ask needed to be scoped more appropriately.",
          ]}
          listItems={[
          ...
          <div className='container'>
            <div className='row'>
              ...
              <div className='col-lg-8'>
                ...
                >
                  “On behalf of Corporate Environmental Affairs we thank you for
                  your help in improving the design of one of our flagship
                  reports which we take pride in producing every year.
                </p>
                <p
                  style={{
                    fontSize: "18px",
                ...
                >
                  It also did not escape us the fact that you volunteered to
                  help us and you took on this extra work even though it had
                  nothing to your regular responsibilities. For this, we doubly
                  THANK YOU! It was such a refreshing experience working with
                  you, and I learned something.
                </p>
                <p
                  style={{
                    fontSize: "18px",
                ...
                >
                  You were confident yet respectful and above all, patient with
                  the numerous iterations that we made. You reflect the best of
                  IBM. I hope our paths cross again and I wish you all the
                  successes.”
                </p>
                <p
                  style={{
