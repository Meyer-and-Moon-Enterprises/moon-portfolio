  ...
  return (
    <>
      ...
      >
        ...
        <CaseImage image='/images/grassboots/cs-grassboots-image-01.png' />

        <CaseText
          title='My contributions & process'
          description={[
            "I first joined the ranks of the Grassboots collective as a volunteer that helped take the studio compost out. Over time my role morphed into something akin to president. ",
          ]}
          listItems={[
